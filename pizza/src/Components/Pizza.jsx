...
function Asset({ props }) {
    ...
    if(props.includes("White")) {
        ...
        if(props.includes("Cheddar")){ basemat = materials.ZA_WHITE_SAUCE_MOZ; }
        if(props.includes("Mozzarella")){ basemat = materials.ZA_WHITE_SAUCE_CHEDDAR; }
    }
    ...
    if(props.includes("Wheat") || props.includes("Gltn Free")){
        ...
        if(props.includes("Cheddar")){ basemat = materials.ZA_WHEAT_SAUCE_MOZ; }
        if(props.includes("Mozzarella")){ basemat = materials.ZA_WHEAT_SAUCE_CHEDDAR; }
    }
